...
|13. Coursera "Assets, Threats, and Vulnerabilities" Course |2/6/2025| | * |
...
|22. Udemy - Mastering Thymeleaf with Spring Boot [Course]|3/20/2025| | * |
...
- Java/Engineering Book Club
  ...
  - Books Selected
    ...
    - Algorithms, 4th Edition by Sedgewick+Wayne
      ...
      - [Knuth Shuffle](https://golangprojectstructure.com/the-knuth-shuffle/)
...
- Project Idea - Create a web based log collector
- Project Idea - freeCodeCamp
  - https://github.com/freeCodeCamp/freeCodeCamp?tab=readme-ov-file
  - Write a "paper" or "set of notes" on each project
- Create a Tic-Tac-Toe project in React
  - check out https://codepen.io/JP-CSStudent/pen/XJrOWgW
- From David:
  - https://www.sillycycle.com/x11.html
- Wallhalla 2
  - Quaterfinals
    - Yo vs. Viper [predict: 2-4 Viper] []
    - ACCM vs. FreakinAndy [predict: 2-4 FreakinAndy] []
